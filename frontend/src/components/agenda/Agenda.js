...
const AgendaPage = (props) => {
  ...
  const onPopupOpen = (args) => {
    ...
    const eventTemplate = (props) => {
        return (
            <div className="template-wrap" style={{ backgroundColor: props.OwnerColor, padding: '0px 5px', color: 'black'}}>
                <div className="subject" style={{ backgroundColor: props.OwnerColor, fontWeight: '500' }}>{props.Subject}</div>
            ...
            <div className="agenda-section">
                <div className="agenda-calendar">
                    <ScheduleComponent 
                        ...
                        eventSettings={{ dataSource: calendarData, template: eventTemplate, enableTooltip: true }}
                        rowAutoHeight={true}
                        >
                        <ViewsDirective>
